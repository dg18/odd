...
RUN pip3 -qq install --prefix=/usr/local --no-cache-dir --upgrade --requirement https://raw.githubusercontent.com/indexa-git/l10n-dominicana/12.0/requirements.txt
